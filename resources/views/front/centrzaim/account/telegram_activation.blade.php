                            ...
                            <form
                                ...
                                <div class="max-w-[416px] flex xl:flex-row flex-col gap-4">
                                    <input maxlength="6" required name="code"
                                           ...
                                           placeholder="Пароль из смс" class="p-3 rounded w-full max-sm:text-center bg-gray-100 h-[60px] rounded-xl">
                                ...
                                <div class="get-money-wrapper flex flex-row justify-start w-full sm:w-auto">
                                    <div class="flex flex-col justify-center gap-8 justify-start w-full sm:w-auto">
                                        <button type="submit" class="get-code-btn">
                                            @include('blocks.components.get-money-btn', ['btnText' => 'Подтвердить', 'class' => '!bg-[#2F76E2]', 'activeBtn' => true])
                                        </button>
                                        <div class="text-[#484E63] font-bold text-sm text-center cursor-pointer">Подтвердить по СМС</div>
                                    </div>
                                </div>
                            </form>
                        </div>
