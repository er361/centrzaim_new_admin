...
@endsection
@section('content')
    @include('blocks/slider-money-block')
    @include('blocks/why-us-block')
    @include('blocks/blue')
    @include('blocks/how-to-block')
    @include('blocks/money-to-block')
    @include('blocks.slider-money-block', ['isWhiteBg' => true])
    @include('blocks/faq')
@endsection
@section('scripts')
    <script>
