...
@section('scripts')
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function () {
            // Устанавливаем значения из localStorage в элементы с data-атрибутами
            const sumValueElement = document.querySelector('[data-sum-value]');
            const daysValueElement = document.querySelector('[data-days-value]');

            const sum = localStorage.getItem('sum') || '51 000 ₽';
            const days = localStorage.getItem('days') || '365 дней';

            if (sumValueElement) {
                sumValueElement.textContent = sum;
            }
